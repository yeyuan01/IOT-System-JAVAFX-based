...
public class SmartPlugControllerTest extends ApplicationTest {
	...
	public void start(Stage stage) throws IOException {
		...
		adminController.setmodel(hub);
 		...
 		SmartPlugController cc = new SmartPlugController(hub,smartPlug,adminController,mainController);
	...
	@Test
	public void testToggleSmartPlug() {
		verifyThat("#SmartPlugOnoff", hasText("Off"));
		assertFalse(smartPlug.getIsOn());
		clickOn("#SmartPlugToggleButton");
		verifyThat("#SmartPlugOnoff", hasText("On"));
		assertTrue(smartPlug.getIsOn());
		clickOn("#SmartPlugToggleButton");
		verifyThat("#SmartPlugOnoff", hasText("Off"));
		assertFalse(smartPlug.getIsOn());
	}
